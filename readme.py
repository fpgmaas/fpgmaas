...
tree = Tree("🙂 [link=https://fpgmaas.com]Florian Maas", guide_style="bold bright_black")

python_tree = tree.add("📦 Open Source Packages", guide_style="bright_black")
python_tree.add("[bold link=https://github.com/fpgmaas/deptry]deptry[/]              - [bright_black] Find unused, missing and transitive dependencies in a Python project")
python_tree.add("[bold link=https://github.com/fpgmaas/cookiecutter-poetry]cookiecutter-poetry[/]              - [bright_black] A modern cookiecutter template for Python projects that use Poetry for dependency management")
python_tree.add("[bold link=https://github.com/fpgmaas/ckit]ckit[/]              - [bright_black] A command line utility to help you organise and quickly run frequently used commands")
python_tree.add("[bold link=https://github.com/fpgmaas/simple-homepage]simple-homepage[/]              - [bright_black] A command line utility that helps you create a personal homepage for your browser.")
